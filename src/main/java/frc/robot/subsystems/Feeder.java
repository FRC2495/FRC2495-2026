...
public class Feeder extends SubsystemBase implements IFeeder{
	...
	static final double FEED_INTEGRAL_GAIN = 0.0001; // An error of 1 rotation per second sustained for 1 second results in 0.0001 V output - reduce if you see oscillations, increase if you see steady state error (i.e. the feeder is running at a velocity slightly below the target velocity)
